...
```{r}
interact_plot(lmm,pred = digital_centered,modx = complexity,  mod2 = group, interval = TRUE,x.label = "Digital Index",y.label = "Error percentage",int.width = .95)
```
...
```{r}
interact_plot(lmm,pred = admin_centered,modx =group, interval = TRUE,x.label = "Admin Index",y.label = "Error percentage",int.width = .95)
```
...
```{r}
interact_plot(lmm,pred = digital_centered,modx = complexity,  interval = TRUE,x.label = "Digital Index",y.label = "Error percentage",int.width = .95)
```
