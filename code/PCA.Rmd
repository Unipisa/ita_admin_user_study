...
```{r}
interact_plot(mod_filtered,pred = PC1,modx =group, mod2=complexity,interval = TRUE,x.label = "Morphological/sentence length related features (PC1)",y.label = "Error percentage",int.width = .95)
```
Plot the main effect of PC1 on subject groups.

```{r}
interact_plot(mod_filtered,pred = PC2,modx =group, interval = TRUE,x.label = "Cohesion/morpho-syntactic related features (PC2)",y.label = "Error percentage",int.width = .95, )
```
